        ...
        <Section id="About">
            ...
            <div className='  mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 md:gap-12 md:px-8'>
                ...
                <div className='flex w-full flex-col justify-center gap-12 md:flex-row '>
                    ...
                    <img className=' rounded-md object-cover transform rotate-3 shadow-xl block  hover:rotate-0 transition duration-200 relative self-center h-[180px] w-[288px]  md:h-[280px] md:w-[200px] lg:h-[420px] lg:w-[331px] md:p-8' loading='lazy' src={image} alt="my photo" srcSet="" />
